...
<nav aria-label="breadcrumb ">
	<ol class="breadcrumb">
		<li class="breadcrumb-item text-black">Archivos Compartidos</li>
	</ol>
</nav>
			...
			<div class="card-body">
				<table class="table" id="datsa" width="100%">
					...
					?>
						...
						$filess = $conn->query("SELECT f.*,u.name as uname FROM users as u, files as f, compartirarchivo as cc WHERE cc.usuario_id=u.id AND cc.archivo_id=f.id and u.id=$user");
						?>
						<?php
