...
<nav aria-label="breadcrumb ">
	<ol class="breadcrumb">
		...
		?>
			<li class="breadcrumb-item text-success"><?php echo $path['name']; $creador = $_SESSION['login_id']; $id_usuario = $path['user_id'] ?></li>
		<?php
			$id = $path['parent_id'];
		}
		?>
...
<div id="menu-file-clone" style="display: none;">
	...
	<!-- <a href="javascript:void(0)" class="custom-menu-list file-option share-alt"><span><i class="fa fa-share-alt"></i> </span>Compartir</a> -->
...
<script>
	...
	$('.folder-item').bind("contextmenu", function(event) {
		...
		$("div.custom-menu .share-alt").click(function(e) {
			e.preventDefault()
			uni_modal('Compartir Carpeta', 'comparticarpeta.php?fid=<?php echo $folder_parent ?>&id=' + $(this).attr('data-id'))
		})
